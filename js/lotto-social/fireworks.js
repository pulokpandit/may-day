var Fireworks = function(canvas) {
  ...
  self.init = function() {
    ...
    self.cw = self.canvas.width;
    self.ch = self.canvas.height;
  ...
  self.bindEvents = function() {
    ...
    //   self.mx = Math.random() * 500;
    //   self.my = Math.random() * 500;
...
//      canvas.style.display = "block";
    ...
    while (c--) {
      ...
      var yPos = rand(y, height + y);
      self.fireworks.push(new Firework(xPos, y + 1, xPos, y));
    }
  };

  self.showCircularFireworks = function(x, y, radius, steps) {
    var initialCount = steps;
    var angleStep = (2 / steps) * Math.PI;
    var angle = 0;
    while (initialCount--) {
      setTimeout(function() {
        ...
        angle += angleStep;
        self.fireworks.push(new Firework(xPos, yPos + 1, xPos, yPos));
      }, 50);
    }
  };
